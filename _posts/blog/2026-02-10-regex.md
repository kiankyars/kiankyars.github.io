...
Today I am going to be building sqlite from scratch, but this time I'm going to be using both Codex and Claude on the same project to see how heterogeneous agents interact with each other.
