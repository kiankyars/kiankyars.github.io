...
Here are my raw and somewhat naive goals for 2025 that I wrote in apple notes. For goals that are habits, I track them in a Google sheet. So if that goal has a corresponding entry in my habit tracker, then I won't comment on it. You can check the appendix to see it.
...
- **Ultimate goals:**
  ...
  - appear on the Dwarkesh podcast
    > these was naive, but I will still remain as unrealistically ambitious
...
- Made some positive impact which people know me for already.
...
- If I find something to obsess over, then I want to optimize for commitment, but if not, then I want to optimize for optionality because I have always wanted to travel the world and see places.
