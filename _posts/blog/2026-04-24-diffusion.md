...
This is the microscopic intuition behind [Fick's law](https://en.wikipedia.org/wiki/Fick%27s_laws_of_diffusion): net flow is proportional to the concentration gradient. The random-walk picture is also the same tradition as Einstein's explanation of Brownian motion: macroscopic smoothness emerging from molecular randomness.
